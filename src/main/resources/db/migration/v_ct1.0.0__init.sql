...
(
    ...
    `employees_num`                       int(2) not null default 0 comment '职场人数(0-10人0，10-20人1，20-50人2，50-100人3，100-200人4，200人以上5)',
    `department_num`                      int(2) not null default 0 comment '部门人数(0-10人0，10-20人1，20-50人2，50-100人3，100-200人4，200人以上5)',
    ...
    `break_time_day`                      char(2) NULL default null comment '中午休息分钟数',
    `social_security_time`                tinyint(1) not null comment '社保缴纳时间(0入职当月的上半月,1入职当月的下半月,2入职的次月,3转正后,4半年后,5一年后,6不缴纳)',
    `social_security_base_fund`           varchar(4) NULL default null comment '社保基数',
    `social_security_proportion`          varchar(512) NULL default null comment '社保系数',
    `public_accumulation_time`            tinyint(1) not null comment '公积金缴纳时间(0入职当月的上半月,1入职当月的下半月,2入职的次月,3转正后,4半年后,5一年后,6不缴纳)',
    `public_accumulation_fund`            varchar(512) NULL default null comment '公积金基数',
    `public_accumulation_fund_proportion` varchar(512) NULL default null comment '公积金系数',
    ...
    `quarterly_award_flag`                tinyint(1) not null default 0 comment '是否有项目奖(0否;1是)',
